...
LDLIBSOPTIONS=../../../../Scs/Linux/Scs/dist/Debug/GNU-Linux/libscs.a -lpthread

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scstest

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scstest: ../../../../Scs/Linux/Scs/dist/Debug/GNU-Linux/libscs.a
...
${OBJECTDIR}/_ext/1ad155ca/ScsTest.o: ../../../Source/ScsTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1ad155ca/ScsTest.o ../../../Source/ScsTest.cpp

# Subprojects
.build-subprojects:
	cd ../../../../Scs/Linux/Scs && ${MAKE}  -f Makefile CONF=Debug
...
# Subprojects
.clean-subprojects:
	cd ../../../../Scs/Linux/Scs && ${MAKE}  -f Makefile CONF=Debug clean
