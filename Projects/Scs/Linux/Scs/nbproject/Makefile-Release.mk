...
${OBJECTDIR}/_ext/5555977b/Scs.o: ../../../../Source/Scs.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5555977b/Scs.o ../../../../Source/Scs.cpp

${OBJECTDIR}/_ext/5555977b/ScsAddress.o: ../../../../Source/ScsAddress.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5555977b
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5555977b/ScsAddress.o ../../../../Source/ScsAddress.cpp

${OBJECTDIR}/_ext/5555977b/ScsClient.o: ../../../../Source/ScsClient.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5555977b
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5555977b/ScsClient.o ../../../../Source/ScsClient.cpp

${OBJECTDIR}/_ext/5555977b/ScsCommon.o: ../../../../Source/ScsCommon.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5555977b
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5555977b/ScsCommon.o ../../../../Source/ScsCommon.cpp

${OBJECTDIR}/_ext/5555977b/ScsReceiveQueue.o: ../../../../Source/ScsReceiveQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5555977b
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5555977b/ScsReceiveQueue.o ../../../../Source/ScsReceiveQueue.cpp

${OBJECTDIR}/_ext/5555977b/ScsSendQueue.o: ../../../../Source/ScsSendQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5555977b
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5555977b/ScsSendQueue.o ../../../../Source/ScsSendQueue.cpp

${OBJECTDIR}/_ext/5555977b/ScsServer.o: ../../../../Source/ScsServer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5555977b
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5555977b/ScsServer.o ../../../../Source/ScsServer.cpp

${OBJECTDIR}/_ext/5555977b/ScsSocket.o: ../../../../Source/ScsSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5555977b
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5555977b/ScsSocket.o ../../../../Source/ScsSocket.cpp
